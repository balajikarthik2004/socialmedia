...
const RightBar = () => {
  return (
    <div className='hidden lg:block col-span-4 overflow-y-scroll scroll-smooth no-scrollbar p-5 pl-2'>
        {/* friendRequests */}
        {friendRequests.length > 0 && <div className="bg-white rounded-lg shadow px-4 py-3 pb-1 dark:bg-[#171717] dark:text-white">
        ...
        {/* suggestions */}
        <div className={`${friendRequests.length && "mt-5"} bg-white rounded-lg shadow px-4 py-3 pb-1 dark:bg-[#171717] dark:text-white`}>
