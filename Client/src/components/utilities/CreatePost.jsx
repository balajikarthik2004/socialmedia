    ...
    <div className="bg-white px-3 sm:px-4 py-2 rounded-lg shadow dark:bg-[#171717] dark:text-white">
      <div className="flex gap-4 items-center">
        <img
          ...
          alt="userImage"
          className="h-8 w-8 sm:h-9 sm:w-9 rounded-full object-cover outline-0 shadow"
        />
        <input
          type="text"
      ...
      <div className="flex justify-between">
        ...
        <div>
          <button className="py-1.5 px-2 rounded bg-blue-600 hover:bg-blue-700 text-white text-sm">
            Share
          </button>
        </div>
      </div>
